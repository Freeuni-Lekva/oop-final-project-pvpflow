...
public class QuizDAOTest {
    ...
    public void testQuizCreatorAndHistory() throws SQLException {
        ...
        try (Connection conn = DBUtil.getConnection()) {
            ...
            System.out.println("Using creator1 ID: " + creator1Id + ", creator2 ID: " + creator2Id);

            int quiz1Id = QuizDAO.createQuiz(conn, creator1Id, "Creator 1 Quiz", "First creator's quiz",
                                           false, false, false, false);
            System.out.println("Created quiz1 with ID: " + quiz1Id);
            int quiz2Id = QuizDAO.createQuiz(conn, creator2Id, "Creator 2 Quiz", "Second creator's quiz",
                                           true, true, true, true);
            System.out.println("Created quiz2 with ID: " + quiz2Id);

            // Commit quizzes first so they're visible to other connections
            conn.commit();
            System.out.println("Committed quizzes to database");
            ...
            System.out.println("Creator 1 has " + creator1Quizzes.size() + " quizzes");
            ...
            System.out.println("Creator 2 has " + creator2Quizzes.size() + " quizzes");
            ...
            System.out.println("Creator 1 quiz count: " + creator1Count);
            ...
            System.out.println("Creator 2 quiz count: " + creator2Count);
            ...
            System.out.println("Created submission1 with ID: " + submission1Id);
            int submission2Id = quizDAO.saveSubmission(conn, quiz2Id, creator1Id, 10, 10, 100.0, false, 90);
            System.out.println("Created submission2 with ID: " + submission2Id);

            // Commit submissions so they're visible to other connections
            conn.commit();
            System.out.println("Committed submissions to database");
            ...
            System.out.println("User history has " + userHistory.size() + " records");
            ...
            System.out.println("All quizzes with stats: " + allQuizzes.size());
            ...
            System.out.println("All quizzes basic: " + allQuizzesBasic.size());
